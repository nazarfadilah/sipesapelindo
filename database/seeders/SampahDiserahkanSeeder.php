...
class SampahDiserahkanSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $tujuans = TujuanSampah::pluck('id')->toArray();
        ...
        for ($i = 0; $i < 30; $i++) {
            SampahDiserahkan::create([
                ...
                'jumlah_berat' => $faker->numberBetween(5, 300),
                'tgl' => Carbon::now()->subDays($faker->numberBetween(0, 365))->toDateString(),
                'id_diserahkan' => $faker->randomElement($tujuans),
                'foto' => null,
            ]);
        }
    }
