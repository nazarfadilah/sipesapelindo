    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="bg-white p-4 rounded-bottom shadow">
                ...
                <form action="{{ route('admin.data.sampah-terkelola.update', $sampah->id_sampah) }}" method="POST" enctype="multipart/form-data" id="formEditSampah">
                    @csrf
                    @method('PUT')
    ...
    btnBack.addEventListener('click', function (e) {
        ...
        if (formChanged) {
            showConfirm(
                ...
                () => {
                    formChanged = false;
                    window.location.href = "{{ route('admin.data.sampah-terkelola') }}";
                }
            );
        } else {
            window.location.href = "{{ route('admin.data.sampah-terkelola') }}";
