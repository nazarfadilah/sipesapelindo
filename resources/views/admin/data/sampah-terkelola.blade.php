...
<div class="content-area">
    ...
    <div class="card">
        <div class="card-body bg-primary text-white">
            <h5 class="mb-0">Lihat Data Sampah > Sampah Terkelola</h5>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="sampahTerkelolaTable">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const table = $('#sampahTerkelolaTable').DataTable({
            pageLength: 10,
            order: [[0, 'asc']],
            language: {
                paginate: {
