            ...
            <form action="{{ route('admin.dokumen.update', $dokumen->id) }}" method="POST" enctype="multipart/form-data" id="dokumenForm">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control @error('judul_dokumen') is-invalid @enderror" id="judul_dokumen" name="judul_dokumen" value="{{ old('judul_dokumen', $dokumen->judul_dokumen) }}" required>
                        @error('judul_dokumen')
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control @error('berlaku') is-invalid @enderror" id="berlaku" name="berlaku" value="{{ old('berlaku', \Carbon\Carbon::parse($dokumen->berlaku)->format('Y-m-d')) }}" required>
                        @error('berlaku')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
