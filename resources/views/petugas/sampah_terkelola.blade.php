    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div style="background-color: #1E3F8C" class="p-4 rounded-top">
                <h4 class="text-white mb-0">Lihat Riwayat Inputan > Sampah Terkelola</h4>
            </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if ($sampah->foto)
                            <a href="{{ asset('storage/' . $sampah->foto) }}" target="_blank" class="btn-lihat-foto" onclick="showImage(event, '{{ asset('storage/' . $sampah->foto) }}')">
                ...
                @empty
                <tr>
                    <td colspan="7" class="text-center py-3">Tidak ada data sampah terkelola</td>
                </tr>
                @endforelse
                    </tbody>
                    </table>
