...
<div class="content-area">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <form action="{{ route('superadmin.laporan.bulanan') }}" method="GET" class="d-flex align-items-center">
    ...
    <div class="alert alert-info">
        <strong>Periode:</strong> {{ \Carbon\Carbon::create($year, $month, 1)->format('F Y') }}
    </div>
