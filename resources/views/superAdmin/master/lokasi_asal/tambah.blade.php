...
@section('title', 'Tambah Lokasi Asal')
...
<div class="content-area-form">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('superadmin.master.lokasi-asal.store') }}" method="POST" id="lokasiForm">
                @csrf
...
@push('scripts')
<script>
    setupFormConfirmation('lokasiForm', 'Apakah Anda yakin ingin menyimpan data lokasi asal ini?');
</script>
@endpush
