    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div style="background-color: #1E3F8C" class="p-4 rounded-top">
                <h4 class="text-white mb-0">Semua Data Sampah > Sampah Diserahkan</h4>
            </div>
            <div class="bg-white p-4 rounded-bottom shadow">
                <div class="table-responsive">
                    <table id="sampah-diserahkan-table" class="table table-striped table-bordered w-100">
...
<script>
    $(document).ready(function() {
        $('#sampah-diserahkan-table').DataTable({
            responsive: true,
            pageLength: 10,
